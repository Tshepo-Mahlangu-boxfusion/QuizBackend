...
{
    public abstract class QuizTWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static QuizTWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(QuizTWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<QuizTDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<QuizTDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<QuizTDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<QuizTDbContext, Task<T>> func)
        {
            T result;
